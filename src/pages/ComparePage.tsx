...
export function ComparePage() {
  ...
  const displayValue = (row: Row, item: Solution) => {
    if (row.label[1] === 'Primary role') return item.summary[locale]
    if (row.label[1] === 'Ideal use') return item.idealFor[locale].join(' · ')
