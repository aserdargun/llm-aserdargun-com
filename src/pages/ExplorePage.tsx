...
export function ExplorePage() {
  ...
  useEffect(() => {
    if (!drawer) return
    filterDrawer.current?.focus()
    const previousOverflow = document.body.style.overflow
    document.body.style.overflow = 'hidden'
    const background = [...document.querySelectorAll<HTMLElement>('.site-header, .site-footer, .explore-page > :not(.drawer-backdrop)')]
