...
export function HomePage() {
  ...
  return <>
    <section className="home-hero">
      ...
      <div className="shell hero-source mono"><span><CircleDot size={12} />{pick(locale, 'RESMÎ BELGE VE DEPO KAYNAKLARI', 'OFFICIAL DOCUMENTATION AND REPOSITORIES')}</span><span>{pick(locale, 'VERİ DENETİMİ', 'DATASET REVIEWED')} · {ATLAS_DATASET_REVIEWED_AT}</span></div>
    </section>
