...
export function MethodologyPage() {
  ...
  return <div className="shell page-shell methodology-page">
    <div className="page-heading"><div><h1>{pick(locale, 'Metodoloji ve kaynak politikası', 'Methodology and source policy')}</h1><p>{pick(locale, 'Sınıflandırma sınırlarını, kanıt standardını ve performans dilini açık hale getiriyoruz.', 'We make taxonomy boundaries, evidence standards, and performance language explicit.')}</p></div><span className="freshness mono">ATLAS · 2026-08-12</span></div>
