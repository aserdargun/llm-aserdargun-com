...
const layerVisuals: LayerVisual[] = [
  ...
  { id: 'APP', icon: Monitor, role: { tr: 'Arayüz', en: 'Interface' }, plain: { tr: 'Sohbet edip deney yaptığın masaüstü veya web arayüzü.', en: 'The desktop or web interface where you chat and experiment.' }, analogy: { tr: 'Arabanın direksiyonu ve göstergeleri: kullanıcının dokunduğu yer.', en: 'The steering wheel and dashboard: what the user touches.' }, examples: ['LM Studio', 'Jan', 'GPT4All'] },
  ...
  { id: 'EDG', icon: Smartphone, role: { tr: 'Cihaz', en: 'Device' }, plain: { tr: 'Modeli telefonunda veya tarayıcında çalıştırabilir; veri çıkışı uygulamanın ağ davranışına bağlıdır.', en: 'Can run the model on your phone or browser; data egress depends on application network behavior.' }, analogy: { tr: 'Cebindeki mini kütüphane: internet gerekmeden cevap verir.', en: 'A mini library in your pocket: answers without the internet.' }, examples: ['WebLLM', 'ExecuTorch'] },
]
...
const journey = [
  ...
  { icon: Cpu, title: { tr: 'Motor çalışır', en: 'The engine runs' }, body: { tr: 'Seçilen sunucunun yürütme motoru modeli çalıştırıp token üretir; her sunucu her motorla birleşmez.', en: 'The chosen server’s execution engine runs the model and generates tokens; not every server combines with every engine.' }, layer: 'INF' },
